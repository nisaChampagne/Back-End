...
public class SeedData implements CommandLineRunner
{
    ...
    public void run(String[] args) throws Exception {
        ...
        u1.getPlants().add(new Plant("Sunflower", "TEST Sunny", "Front Porch", u1, 3));
        u1.getPlants().add(new Plant("Spider Plant", "TEST Spidey", "Family Room", u1, 2));
        ...
        u3.getPlants().add(new Plant("Jade Plant", "TEST Jade", "Front Porch", u3, 4));
        u3.getPlants().add(new Plant("Peacock Plant", "TEST PeeWee", "Bedroom", u3, 1));
        u3.getPlants().add(new Plant("Climbing Fig", "TEST Figgy", "Back Deck", u3, 2));
        u3.getPlants().add(new Plant("Rubber Fig", "TEST Ber", "Family Room", u3, 3));
        userRepository.save(u3);

        users = new ArrayList<>();
        users.add(new UserRoles(new User(), r2));
        User u4 = new User("dos", "password", "310-333-1234", users);
        u4.getPlants().add(new Plant("Devil's Ivy", "TEST Lucifer", "Family Room", u4, 4));
        u4.getPlants().add(new Plant("Lucky Bamboo", "TEST Bambi", "Kitchen", u4, 4));
